...
interface CrewServicesModalReadOnlyProps {
  isOpen: boolean;
  onClose: () => void;
}

const CrewServicesModalReadOnly = ({ isOpen, onClose }: CrewServicesModalReadOnlyProps) => {
            ...
            <table className="w-full">
              ...
              <tbody>
                {fieldsData.map((field) => (
                  <tr key={field.id} className="border-b border-[#cacaca]">
                    <td className="py-4">
                      <span className="text-[#000000] font-medium">
                        {field.id}. {field.name}
                      </span>
                    </td>
                    <td className="py-4 text-sm">{field.date}</td>
                    <td className="py-4">
                      {field.notes && <ChatBubbleIcon className="text-[#003366]" sx={{ fontSize: 16 }} />}
                    </td>
                    <td className="py-4">
...
export default CrewServicesModalReadOnly;
