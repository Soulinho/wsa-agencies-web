...
const NavFooterCustomer = () => {
  ...
  const navItems = [
    { title: 'Inicio', icon: <HomeIcon className="text-2xl md:text-3xl" />, path: '/customer' },
    { title: 'Mis Naves', icon: <DirectionsBoatIcon className="text-2xl md:text-3xl" />, path: '/customer/view-vessels' },
...
export default NavFooterCustomer;
