...
import NavFooterCustomer from './NavFooterCustomer';
  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-32">
      ...
      <div className="bg-[#00335F] py-4 flex justify-between items-center">
        <h1 className="text-[28px] font-bold text-white container mx-auto px-4">Mis Naves</h1>
        <button 
            ...
            <table className="w-full">
              ...
              <tbody>
                {vessels.map((vessel, index) => (
                  <tr key={index} className="border-b border-[#cacaca] relative">
                    <td className="px-6 py-4">{vessel.daId}</td>
                    <td className="px-6 py-4 text-[#0066FF]">
                      <button
                        onClick={() => navigate(`/customer/vessel-details/${vessel.daId}`)}
