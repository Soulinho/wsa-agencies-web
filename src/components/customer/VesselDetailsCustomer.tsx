...
import CrewServicesModalReadOnly from './CrewServicesModalReadOnly';

const VesselDetailsCustomer = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-[#00335F] py-4 flex justify-between items-center">
        ...
        <button 
          onClick={() => navigate('/customer/view-vessels')}
...
export default VesselDetailsCustomer;
