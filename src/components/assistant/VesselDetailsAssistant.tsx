...
import NavFooterAssistant from './NavFooterAssistant';
...
import CrewServicesModalAssistant from './CrewServicesModalAssistant';

const VesselDetailsAssistant = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-[#00335F] py-4 flex justify-between items-center">
        ...
        <button 
          onClick={() => navigate('/assistant/manage-vessels')}
...
export default VesselDetailsAssistant;
