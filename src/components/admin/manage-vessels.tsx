...
import VesselRegistrationModal from './vessel/VesselRegistrationModal';
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
          ...
          <button 
            ...
            className="w-full md:w-[220px] lg:w-[220px] bg-[#00A72C] text-white font-bold px-4 h-[50px] rounded-lg hover:bg-[#008f25] shrink-0"
          >
            + Nueva nave
          </button>
        </div>
                ...
                {vessels.map((vessel, index) => (
                  <tr key={index} className="border-b border-[#cacaca]">
                    ...
                    <td className="px-6 py-4 text-[#0066FF]">
                      <button
                        onClick={() => navigate(`/vessel/${vessel.daId}`)}
