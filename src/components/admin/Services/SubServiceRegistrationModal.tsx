...
interface SubServiceRegistrationModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const SubServiceRegistrationModal = ({ isOpen, onClose }: SubServiceRegistrationModalProps) => {
    ...
    >
      <div className="bg-white rounded-lg p-4 md:p-6 w-full md:w-[500px] max-h-[90vh] overflow-y-auto shadow-xl">
        <div className="flex flex-col items-center mb-6 relative">
          ...
          <h2 className="text-[26px] font-bold text-[#003366]">Nuevo Sub-Servicio</h2>
...
export default SubServiceRegistrationModal;
