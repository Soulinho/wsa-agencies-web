...
import CrewServicesModal from '../admin/vessel/CrewServicesModal';
import ServiceSelectionModal from '../admin/vessel/ServiceSelectionModal';

const VesselDetailsOperator = () => {
...
export default VesselDetailsOperator;
