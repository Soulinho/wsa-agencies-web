            ...
            >
              ...
              <div className="mt-4">
                <button 
                  ...
                  className="w-full bg-[#00335F] text-white py-2 px-4 rounded-lg hover:bg-[#002347] transition-colors font-medium"
                >
                  Seleccionar
                </button>
              </div>
